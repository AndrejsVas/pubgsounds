angular.module('app', [])
    .controller('maincontroller', function () {
        ...
        vm.init = function () {
            ...
            var weaponRangeUnsilenced = ["600", "300", "400" ,"x", "400" ,"x" , "x" ,     "500" , "800"   , "x" ,         "x"           ,"x" ,   "x"       , "x"     ,"x"    ,"x"    , "500",       "x" ,  "x","500",   "x",   "x",   "x"   ,   "x"            ,   "x" ,   "x" ,     "0"];
            var weaponRangeSilenced = ["300", "0", "200" , "x" , "100" ,"x" ,   "x" ,      "0" ,  "x"   , "x" ,         "x"           ,"x" ,   "x"       , "x"     ,"x"    ,"x"    , "300",       "x" ,  "x",  "300",   "x",   "x",   "x"   ,   "x"           ,   "x"   ,   "x"  ,   "0"];
